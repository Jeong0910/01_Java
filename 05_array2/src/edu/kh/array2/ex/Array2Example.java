...
public class Array2Example {
	 ...
	 * 2차원 배열
	 * 
	 * - 자료형이 같은 1차원 1배열을 묶음으로 다루는 것 -> 행, 열 개념이 추가
	 * 
	 * 
	 */
	...
	public void ex1() {
		...
		/*
		 * arr[0][0] = 10; arr[0][1] = 20; arr[0][2] = 30; arr[1][0] = 40; arr[1][1] =
		 * 50; arr[1][2] = 60;
		 */

		// Arrays.toString() :
		// 참조하고 있는 1차원 배열의 값을 문자열로 반환
	...
	public void ex2() {
		...
		for (int row = 0; row < arr.length; row++) { // 행 반복(0,1,2)
			...
			for (int col = 0; col < arr[row].length; col++) { // 열 반복(3,4,5)
	...
	public void ex3() {
		// 가변 배열
		// - 2차원 배열 생성 시 마지막 배열 차수(열)를 미리 지정하지 않고
