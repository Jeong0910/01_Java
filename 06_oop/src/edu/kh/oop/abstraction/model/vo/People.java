...
public class People { // 국민(사람) 클래스
	...
	// [접근제한자] == public - 자료형 변수명;

	private String name; // 이름
	private char gender; // 성별
	private String pNo; // 주민등록번호 "12345=1234567"
	...
	public String getName() {
		...
		// return ____ : 반환, 되돌려주다
		// return;은 현재 메서드를 종료하고 호출한 쪽으로 되돌아감.
	...
	// getter() : 반환형이 무조건 있음
	// getter는 필드에 작성된 변수값을
	// 호출한 쪽으로 되돌려주는것
	// -> 변수값은 자료형이 있음
	// -> 그 변수를 되돌려준다면 당연히 반환형도 존재함!
	// stter() : 반환형이 없음
	// stter는 전달인자에 작성된 값을 통해
	// 매개변수로 들어온 값을 객체의 필드에 세팅하는 역할.
	// -> 매개변수가 항상 있음(==전달인자 값)
	// -> 전달인자에는 자료형이 있음 -> 매개변수 자료형이 있음.
	// -> 매개변수 작성번 : (자료형이 매개변수명)
