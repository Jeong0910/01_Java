package kh.edu.collection.pack2.model.service;
...
public class SetService {
	...
	/*
	 * Set(집합, 주머니) - 기본적으로 순서를 유지하지 않는다 (index 없음!) - 중복데이터도 저장하지 않는다 Set 인터페이스의 자식
	 * 클래스 1. HashSet(대표) : 처리 속도가 빠른 Set 2. Linked HashSet : 순서를 유지하는 Set 3.
	 * TreeSet : 자동 정렬되는 Set
	 * 
	 */
	...
	public void method1() {
		...
		// 중복 저장이 안된다. (null도 마찬가지)
		// TreeSet은 null 저장 안함
		// (자동정렬을 위해 내부적으로 comepareTo() 라는 메서드 이용 시
	...
	public void method2() {
		...
		System.out.println("[List로 변화]");
		
		// Set에 저자오딘 객체를 이용해서 List를 생성
	...
	public void method3() {
		...
		// Hashcode에 들어간 객체<>에서 오버라이딩을 해야함.
		//*************************************************
		...
		// - A.equals(B) : A와 B가 가지고 있는 필드값이 전부 같은면 true
		System.out.println(p1.equals(p2));
		System.out.println(p1.equals(p3));
	}
	
	/**
	 *  TreeSet(자동 정렬) 이용한 로또번호 생성기
	 *  -> 기본 오름차순 정렬 
	 * 
